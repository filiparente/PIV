...
imsd2=[];
for i=1:length(d),
    im1=rgb2gray(imread((['D:\MEEC\4ºano\PIV\Project\NewData\maizena2\data_rgb\rgb_image1_' d(i).name(12:end-3) 'png'])));
    ims1=[ims1 im1(:)];
    im2=rgb2gray(imread((['D:\MEEC\4ºano\PIV\Project\NewData\maizena2\data_rgb\rgb_image2_' d(i).name(12:end-3) 'png'])));
    ims2=[ims2 im2(:)];
