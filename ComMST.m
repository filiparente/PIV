...
bg_threshold=50; %threshold use to remove background
...
xmin=limits{img,cam}{1,obj}(1);
            ...
            im1=imread(['D:\MEEC\4ºano\PIV\Project\NewData\maizena4\data_rgb\rgb_image2_' d(i).name(12:end-3) 'png']);
            load(['D:\MEEC\4ºano\PIV\Project\NewData\maizena4\data_rgb\depth2_' d(i).name(12:end-3) 'mat'])
...
cam=2;
    for img=1:length(d)
        figure
         im1=imread(['D:\MEEC\4ºano\PIV\Project\NewData\maizena4\data_rgb\rgb_image1_' d(img).name(12:end-3) 'png']);
            load(['D:\MEEC\4ºano\PIV\Project\NewData\maizena4\data_rgb\depth1_' d(img).name(12:end-3) 'mat'])
